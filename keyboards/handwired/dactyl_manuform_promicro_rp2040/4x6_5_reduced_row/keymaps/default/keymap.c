 ...
 */
    ...
    [NUM] = LAYOUT_split_4x6_5(
        ...
        KC_NO,   KC_LEFT, KC_DOWN, KC_RGHT, KC_NO,   KC_NO,         KC_NO,     KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,
                          ...
                          KC_NO,   KC_NO,   KC_NO,   KC_NO,         KC_NO,     KC_NO,   KC_NO,   TO(FPSGAME)
    ),
    ...
    [FPSGAME] = LAYOUT_split_4x6_5(
        ...
        KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,          KC_NO,     KC_NO,   KC_NO,   KC_NO,    KC_NO,  KC_NO,
                          ...
                          KC_C,    KC_LALT, KC_DEL,  KC_ESC,        KC_NO,     KC_ENT,  KC_NO,   TO(QWERTY)
    )
};
